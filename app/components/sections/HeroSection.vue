...
<template>
  ...
  <section class="relative overflow-hidden bg-ink pt-[150px] pb-20 sm:pt-[190px] lg:pt-[243px] lg:pb-[140px]">
    ...
    <div class="pointer-events-none absolute inset-0 z-0 mx-auto hidden h-full w-full max-w-[1213px] px-4 sm:px-6 lg:block">
      ...
      >
        <path
          d="M872 -40C886 60 890 130 862 178C820 230 760 246 702 261C702 238 684 218 662 218C640 218 622 238 622 261C622 285 640 304 662 304C684 304 702 285 702 261C702 240 726 244 738 268C756 305 772 360 781 416C789 470 780 540 767 583C750 650 660 740 570 800"
          stroke="currentColor"
          stroke-width="9.5"
