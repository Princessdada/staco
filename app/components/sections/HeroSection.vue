  ...
  <section class="relative overflow-hidden bg-ink pt-[150px] pb-20 sm:pt-[190px] lg:pt-[243px] lg:pb-[140px]">
    ...
    <div class="pointer-events-none absolute inset-0 z-0 mx-auto hidden h-full w-full max-w-[1213px] px-4 sm:px-6 lg:block">
      ...
      >
        ...
        -->
        <path
          d="M857 -40C862 -13 884 81 886 120C888 159 875 176 866 196C857 216 846 227 836 234C826 241 807 239 792 239C777 239 757 241 744 241C731 241 717 240 704 242C691 244 677 247 664 252C651 257 640 262 630 264C620 266 608 258 604 252C600 246 596 236 598 228C600 220 611 211 618 207C625 203 643 200 656 199C669 198 677 200 688 204C699 208 700 214 704 220C708 226 706 229 706 236C706 243 701 245 702 258C703 271 708 306 712 330C716 354 735 424 745 470C755 516 769 565 772 585C775 605 762 632 752 645C742 658 727 675 710 690C693 705 678 731 662 748C646 765 644 783 638 790"
          stroke="currentColor"
          stroke-width="10.5"
